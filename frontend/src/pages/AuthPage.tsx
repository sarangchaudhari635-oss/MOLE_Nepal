                    ...
                    {screen === 'signin' && (
                        <>
                            ...
                            <button
                                ...
                                className="w-full mt-4 border border-surface-200 rounded-xl py-3 text-[14px] font-medium text-surface-700 hover:bg-surface-50 hover:border-surface-300 transition-all flex items-center justify-center gap-2.5 shadow-sm"
                            >
                    ...
                    {screen === 'signup' && (
                        <>
                            ...
                            <button
                                ...
                                type="button"
                                onClick={handleGoogleSignIn}
                                className="w-full mt-2 border border-surface-200 rounded-xl py-3 text-[14px] font-medium text-surface-700 hover:bg-surface-50 hover:border-surface-300 transition-all flex items-center justify-center gap-2.5 shadow-sm"
                            >
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844a4.14 4.14 0 01-1.796 2.716v2.259h2.908c1.702-1.567 2.684-3.875 2.684-6.615z" fill="#4285F4"/>
                                    <path d="M9 18c2.43 0 4.467-.806 5.956-2.184l-2.908-2.259c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.957v2.332A8.997 8.997 0 009 18z" fill="#34A853"/>
